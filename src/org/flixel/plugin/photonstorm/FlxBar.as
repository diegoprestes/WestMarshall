...
package org.flixel.plugin.photonstorm 
{
	...
	public class FlxBar extends FlxSprite
	{
		...
		private var filledBarColor1:uint;
		private var filledBarColor2:uint;
		 ...
		 */
		public function FlxBar(x:int, y:int, direction:uint = FILL_LEFT_TO_RIGHT, width:int = 100, height:int = 10, parentRef:* = null, variable:String = "", min:Number = 0, max:Number = 100, border:Boolean = false, color1:uint = 0xff005100, color2:uint = 0xff00F400):void
		{
			super(x, y);
			...
			filledBarColor1 = color1;
			filledBarColor2 = color2;
			...
			createFilledBar(filledBarColor1, filledBarColor2, border);
